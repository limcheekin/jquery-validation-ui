                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="person.homeAddress.label" default="Home Address" /></th>
                        
                            <g:sortableColumn property="name" title="${message(code: 'person.name.label', default: 'Name')}" />
                        
                            <th><g:message code="person.workAddress.label" default="Work Address" /></th>
                    ...
                    <g:each in="${personInstanceList}" status="i" var="personInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: personInstance, field: "homeAddress")}</td>
                        
                            <td>${fieldValue(bean: personInstance, field: "name")}</td>
                        
                            <td>${fieldValue(bean: personInstance, field: "workAddress")}</td>
